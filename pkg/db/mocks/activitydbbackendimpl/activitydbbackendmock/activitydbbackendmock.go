...
// with the ActivityDBBackend.Count() method.
...
// with the ActivityDBBackend.Delete() method.
...
// with the ActivityDBBackend.Create() method.
...
// with the ActivityDBBackend.Get() method.
...
// with the ActivityDBBackend.Update() method.
...
// with the ActivityDBBackend.GetAllByOrder() method.
...
// with the ActivityDBBackend.GetByField() method.
...
// with the ActivityDBBackend.GetAll() method.
...
// ActivityDBBackendMock defines a type which implements a struct with the
// methods for the ActivityDBBackend as fields which allows you provide implementations of
// these functions to provide flexible testing.
type ActivityDBBackendMock struct {
...
// Count implements the ActivityDBBackend.Count() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) Count(ctx context.Context) (MethodCallForCount, error) {
...
// Delete implements the ActivityDBBackend.Delete() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) Delete(ctx context.Context, publicID string) (MethodCallForDelete, error) {
...
// Create implements the ActivityDBBackend.Create() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) Create(ctx context.Context, elem pkg.Activity) (MethodCallForCreate, error) {
...
// Get implements the ActivityDBBackend.Get() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) Get(ctx context.Context, publicID string) (MethodCallForGet, error) {
...
// Update implements the ActivityDBBackend.Update() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) Update(ctx context.Context, publicID string, elem pkg.Activity) (MethodCallForUpdate, error) {
...
// GetAllByOrder implements the ActivityDBBackend.GetAllByOrder() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) GetAllByOrder(ctx context.Context, order string, orderBy string) (MethodCallForGetAllByOrder, error) {
...
// GetByField implements the ActivityDBBackend.GetByField() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) GetByField(ctx context.Context, key string, value interface{}) (MethodCallForGetByField, error) {
...
// GetAll implements the ActivityDBBackend.GetAll() method for the ActivityDBBackend.
func (impl *ActivityDBBackendMock) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) (MethodCallForGetAll, error) {
...
// ActivityDBBackendSnitch defines a type which implements a struct with the
// methods for the ActivityDBBackend as fields which allows you provide implementations of
// these functions to provide flexible testing.
type ActivityDBBackendSnitch struct {
	CountMethodCalls []MethodCallForCount
...
// Count implements the ActivityDBBackend.Count() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) Count(ctx context.Context) (int, error) {
	var caller MethodCallForCount
...
// Delete implements the ActivityDBBackend.Delete() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) Delete(ctx context.Context, publicID string) error {
	var caller MethodCallForDelete
...
// Create implements the ActivityDBBackend.Create() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) Create(ctx context.Context, elem pkg.Activity) error {
	var caller MethodCallForCreate
...
// Get implements the ActivityDBBackend.Get() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) Get(ctx context.Context, publicID string) (pkg.Activity, error) {
	var caller MethodCallForGet
...
// Update implements the ActivityDBBackend.Update() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) Update(ctx context.Context, publicID string, elem pkg.Activity) error {
	var caller MethodCallForUpdate
...
// GetAllByOrder implements the ActivityDBBackend.GetAllByOrder() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) GetAllByOrder(ctx context.Context, order string, orderBy string) ([]pkg.Activity, error) {
	var caller MethodCallForGetAllByOrder
...
// GetByField implements the ActivityDBBackend.GetByField() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (pkg.Activity, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the ActivityDBBackend.GetAll() method for the ActivityDBBackend.
func (impl *ActivityDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]pkg.Activity, int, error) {
	var caller MethodCallForGetAll
