...
// with the UserDBBackend.Count() method.
...
// Count implements the UserDBBackend.Count() method for the UserDBBackend.
func (impl *UserDBBackendMock) Count(ctx context.Context) (MethodCallForCount, error) {
...
// Count implements the UserDBBackend.Count() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) Count(ctx context.Context) (int, error) {
	var caller MethodCallForCount
