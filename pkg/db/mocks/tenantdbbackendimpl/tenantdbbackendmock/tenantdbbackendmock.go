...
// with the TenantDBBackend.Count() method.
...
// Count implements the TenantDBBackend.Count() method for the TenantDBBackend.
func (impl *TenantDBBackendMock) Count(ctx context.Context) (MethodCallForCount, error) {
...
// Count implements the TenantDBBackend.Count() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) Count(ctx context.Context) (int, error) {
	var caller MethodCallForCount
