// Package usersessionsql provides a auto-generated package which contains a sql CRUD API for the specific UserSession struct in package pkg.
//
//
...
// values.
func (mdb *UserSessionDB) GetAllByOrder(ctx context.Context, order string, orderby string) ([]pkg.UserSession, error) {
