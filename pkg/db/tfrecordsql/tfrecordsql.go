// Package tfrecordsql provides a auto-generated package which contains a sql CRUD API for the specific TFRecord struct in package pkg.
//
//
package tfrecordsql
...
// values.
func (mdb *TFRecordDB) GetAllByOrder(ctx context.Context, order string, orderby string) ([]pkg.TFRecord, error) {
