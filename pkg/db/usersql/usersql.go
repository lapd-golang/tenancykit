// Package usersql provides a auto-generated package which contains a sql CRUD API for the specific User struct in package pkg.
//
//
package usersql
...
// values.
func (mdb *UserDB) GetAllByOrder(ctx context.Context, order string, orderby string) ([]pkg.User, error) {
