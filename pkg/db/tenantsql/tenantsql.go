// Package tenantsql provides a auto-generated package which contains a sql CRUD API for the specific Tenant struct in package pkg.
//
//
package tenantsql
...
// values.
func (mdb *TenantDB) GetAllByOrder(ctx context.Context, order string, orderby string) ([]pkg.Tenant, error) {
