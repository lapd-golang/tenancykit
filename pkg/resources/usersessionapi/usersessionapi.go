// Package usersessionapi provides a auto-generated package which contains a http restful CRUD API for the specific UserSession struct in package pkg.
//
//
...
// Info receives an http request to get record info for all available records of type "UserSession".
//
// Route: /{Route}/info
// Method: INFO
// RESPONSE-BODY: JSON
func (api *HTTPAPI) Info(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get pkg.UserSession record count"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
	...
	if err := ctx.JSON(http.StatusOK, pkg.UserSessionInfo{Total: total}); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get serialized pkg.UserSession record to response writer"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) Delete(ctx *httputil.Context) error {
	...
	if err := api.operator.Delete(ctx.Context(), publicID); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to delete pkg.UserSession record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) Get(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get pkg.UserSession record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) GetAll(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get all pkg.UserSession record"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
