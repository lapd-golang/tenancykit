// Package userapi provides a auto-generated package which contains a http restful CRUD API for the specific User struct in package tenancykit.
//
//
package userapi
...
type UserRecords struct {
	...
	Records         []tenancykit.User `json:"records"`
}
...
func (api *HTTPAPI) Create(ctx *httputil.Context) error {
	...
	var incoming tenancykit.CreateUser
...
func (api *HTTPAPI) Update(ctx *httputil.Context) error {
	...
	var incoming tenancykit.UpdateUser
...
func (api *HTTPAPI) Delete(ctx *httputil.Context) error {
	...
	if err := api.operator.Delete(ctx, publicID); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to delete tenancykit.User record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) Get(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get tenancykit.User record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
	...
	if err := ctx.JSON(http.StatusOK, requested); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get serialized tenancykit.User record to response writer"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) GetAll(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get all tenancykit.User record"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
