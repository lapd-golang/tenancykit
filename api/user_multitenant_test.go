...
func TestMultiTenantUserAPI(t *testing.T) {
	...
	testMultiTenantUserCount(t, users, userdb)
	testMultiTenantUserGetAll(t, tenantRecord, users, userdb)
	testMultiTenantUserGet(t, tenantRecord, users, userdb)
	testMultiTenantUserUpdate(t, tenantRecord, users, userdb)
	testMultiTenantUserDelete(t, tenantRecord, users, userdb)
}

func testMultiTenantUserCount(t *testing.T, users api.UserAPI, db types.UserDBBackend) {
...
func testMultiTenantUserGetAll(t *testing.T, tenant pkg.Tenant, users api.UserAPI, db types.UserDBBackend) {
...
func testMultiTenantUserGet(t *testing.T, tenant pkg.Tenant, users api.UserAPI, db types.UserDBBackend) {
...
func testMultiTenantUserUpdate(t *testing.T, tenant pkg.Tenant, users api.UserAPI, db types.UserDBBackend) {
...
func testMultiTenantUserDelete(t *testing.T, tenant pkg.Tenant, users api.UserAPI, db types.UserDBBackend) {
