// Package twofactorsessionapi provides a auto-generated package which contains a http restful CRUD API for the specific TwoFactorSession struct in package tenancykit.
//
//
...
// all records of the type tenancykit.TwoFactorSession.
type TwoFactorSessionRecords struct {
	Page            int                           `json:"page"`
	ResponsePerPage int                           `json:"responsePerPage"`
	TotalRecords    int                           `json:"total_records"`
	Records         []tenancykit.TwoFactorSession `json:"records"`
}
...
func (api *HTTPAPI) Create(ctx *httputil.Context) error {
	...
	var incoming tenancykit.TwoFactorSession
...
func (api *HTTPAPI) Delete(ctx *httputil.Context) error {
	...
	if err := api.operator.Delete(ctx, publicID); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to delete tenancykit.TwoFactorSession record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) Get(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get tenancykit.TwoFactorSession record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
	...
	if err := ctx.JSON(http.StatusOK, requested); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get serialized tenancykit.TwoFactorSession record to response writer"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) GetAll(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get all tenancykit.TwoFactorSession record"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
