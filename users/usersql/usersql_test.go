...
import (
	...
	sqldb "github.com/gokit/tenancykit/users/usersql"
)
...
var (
	...
	config = sql.Config{
		DBName:       os.Getenv("users_SQL_DB"),
		User:         os.Getenv("users_SQL_USER"),
		DBIP:         os.Getenv("users_SQL_ADDR"),
		DBPort:       os.Getenv("users_SQL_PORT"),
		DBDriver:     os.Getenv("users_SQL_Driver"),
		UserPassword: os.Getenv("users_SQL_PASSWORD"),
	}
