...
func (impl *TokenDBBackendMock) Create(ctx context.Context, elem tokens.Token) (MethodCallForCreate, error) {
...
func (impl *TokenDBBackendMock) Update(ctx context.Context, publicID string, elem tokens.Token) (MethodCallForUpdate, error) {
...
// Create implements the TokenDBBackend.Create() method for the TokenDBBackend.
func (impl *TokenDBBackendSnitch) Create(ctx context.Context, elem tokens.Token) error {
	var caller MethodCallForCreate
...
// Get implements the TokenDBBackend.Get() method for the TokenDBBackend.
func (impl *TokenDBBackendSnitch) Get(ctx context.Context, publicID string) (tokens.Token, error) {
	var caller MethodCallForGet
...
// Update implements the TokenDBBackend.Update() method for the TokenDBBackend.
func (impl *TokenDBBackendSnitch) Update(ctx context.Context, publicID string, elem tokens.Token) error {
	var caller MethodCallForUpdate
...
// GetByField implements the TokenDBBackend.GetByField() method for the TokenDBBackend.
func (impl *TokenDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tokens.Token, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the TokenDBBackend.GetAll() method for the TokenDBBackend.
func (impl *TokenDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tokens.Token, int, error) {
	var caller MethodCallForGetAll
