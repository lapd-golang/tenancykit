// Package tokenapi provides a auto-generated package which contains a http restful CRUD API for the specific Token struct in package tokens.
//
//
package tokenapi
...
func (api *HTTPAPI) Delete(ctx *httputil.Context) error {
	...
	if err := api.operator.Delete(ctx, publicID); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to delete tokens.Token record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) Get(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get tokens.Token record"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
	...
	if err := ctx.JSON(http.StatusOK, requested); err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get serialized tokens.Token record to response writer"), metrics.WithFields(metrics.Field{
			"error":     err,
			"public_id": publicID,
			"url":       ctx.Request().URL.String(),
		}))
...
func (api *HTTPAPI) GetAll(ctx *httputil.Context) error {
	...
	if err != nil {
		api.metrics.Emit(metrics.Errorf("Failed to get all tokens.Token record"), metrics.WithFields(metrics.Field{
			"error": err,
			"url":   ctx.Request().URL.String(),
		}))
