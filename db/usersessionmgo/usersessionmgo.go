// Package usersessionmgo provides a auto-generated package which contains a sql CRUD API for the specific UserSession struct in package tenancykit.
//
//
...
// GetAllByOrder retrieves all records from the db and returns a slice of tenancykit.UserSession type.
// Records using this DB must have a public id value, expressed either by a bson or json tag
// on the given UserSession struct.
func (mdb *UserSessionDB) GetAllByOrder(ctx context.Context, order, orderBy string) ([]tenancykit.UserSession, error) {
