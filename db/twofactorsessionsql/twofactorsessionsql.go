// Package twofactorsessionsql provides a auto-generated package which contains a sql CRUD API for the specific TwoFactorSession struct in package tenancykit.
//
//
...
func (mdb *TwoFactorSessionDB) GetByField(ctx context.Context, key string, value string) (tenancykit.TwoFactorSession, error) {
	...
	if err := mdb.dx.Get(mdb.table, &elem, key, value); err != nil {
		...
		if err == dsql.ErrNoRows {
			return tenancykit.TwoFactorSession{}, ErrNotFound
		}
