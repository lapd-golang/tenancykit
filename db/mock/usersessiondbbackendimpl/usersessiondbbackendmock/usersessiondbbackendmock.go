...
func (impl *UserSessionDBBackendMock) Create(ctx context.Context, elem tenancykit.UserSession) (MethodCallForCreate, error) {
...
func (impl *UserSessionDBBackendMock) Update(ctx context.Context, publicID string, elem tenancykit.UserSession) (MethodCallForUpdate, error) {
...
func (impl *UserSessionDBBackendMock) GetAllByOrder(ctx context.Context, order string) (MethodCallForGetAllByOrder, error) {
...
type UserSessionDBBackendSnitch struct {
	...
	GetAllByOrderMethodCalls []MethodCallForGetAllByOrder
	GetAllByOrderFunc        func(ctx context.Context, order string) ([]tenancykit.UserSession, error)
...
// Create implements the UserSessionDBBackend.Create() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) Create(ctx context.Context, elem tenancykit.UserSession) error {
	var caller MethodCallForCreate
...
// Get implements the UserSessionDBBackend.Get() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) Get(ctx context.Context, publicID string) (tenancykit.UserSession, error) {
	var caller MethodCallForGet
...
// Update implements the UserSessionDBBackend.Update() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) Update(ctx context.Context, publicID string, elem tenancykit.UserSession) error {
	var caller MethodCallForUpdate
...
// GetAllByOrder implements the UserSessionDBBackend.GetAllByOrder() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) GetAllByOrder(ctx context.Context, order string) ([]tenancykit.UserSession, error) {
	var caller MethodCallForGetAllByOrder
...
// GetByField implements the UserSessionDBBackend.GetByField() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.UserSession, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the UserSessionDBBackend.GetAll() method for the UserSessionDBBackend.
func (impl *UserSessionDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.UserSession, int, error) {
	var caller MethodCallForGetAll
