...
func (impl TFRecordDBBackendImpl) Create(ctx context.Context, elem tenancykit.TFRecord) error {
...
func (impl TFRecordDBBackendImpl) Get(ctx context.Context, publicID string) (tenancykit.TFRecord, error) {
...
func (impl TFRecordDBBackendImpl) Update(ctx context.Context, publicID string, elem tenancykit.TFRecord) error {
...
func (impl TFRecordDBBackendImpl) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.TFRecord, error) {
...
func (impl TFRecordDBBackendImpl) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.TFRecord, int, error) {
