...
func (impl *TFRecordDBBackendMock) Create(ctx context.Context, elem tenancykit.TFRecord) (MethodCallForCreate, error) {
...
func (impl *TFRecordDBBackendMock) Update(ctx context.Context, publicID string, elem tenancykit.TFRecord) (MethodCallForUpdate, error) {
...
func (impl *TFRecordDBBackendMock) GetAllByOrder(ctx context.Context, order string) (MethodCallForGetAllByOrder, error) {
...
type TFRecordDBBackendSnitch struct {
	...
	CreateMethodCalls []MethodCallForCreate
	CreateFunc        func(ctx context.Context, elem tenancykit.TFRecord) error

	GetMethodCalls []MethodCallForGet
	GetFunc        func(ctx context.Context, publicID string) (tenancykit.TFRecord, error)
	...
	GetAllMethodCalls []MethodCallForGetAll
	GetAllFunc        func(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.TFRecord, int, error)
}
...
// Create implements the TFRecordDBBackend.Create() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) Create(ctx context.Context, elem tenancykit.TFRecord) error {
	var caller MethodCallForCreate
...
// Get implements the TFRecordDBBackend.Get() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) Get(ctx context.Context, publicID string) (tenancykit.TFRecord, error) {
	var caller MethodCallForGet
...
// Update implements the TFRecordDBBackend.Update() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) Update(ctx context.Context, publicID string, elem tenancykit.TFRecord) error {
	var caller MethodCallForUpdate
...
// GetAllByOrder implements the TFRecordDBBackend.GetAllByOrder() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) GetAllByOrder(ctx context.Context, order string) ([]tenancykit.TFRecord, error) {
	var caller MethodCallForGetAllByOrder
...
// GetByField implements the TFRecordDBBackend.GetByField() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.TFRecord, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the TFRecordDBBackend.GetAll() method for the TFRecordDBBackend.
func (impl *TFRecordDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.TFRecord, int, error) {
	var caller MethodCallForGetAll
