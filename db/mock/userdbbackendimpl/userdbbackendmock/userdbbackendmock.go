...
func (impl *UserDBBackendMock) Create(ctx context.Context, elem tenancykit.User) (MethodCallForCreate, error) {
...
func (impl *UserDBBackendMock) Update(ctx context.Context, publicID string, elem tenancykit.User) (MethodCallForUpdate, error) {
...
func (impl *UserDBBackendMock) GetAllByOrder(ctx context.Context, order string) (MethodCallForGetAllByOrder, error) {
...
// Create implements the UserDBBackend.Create() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) Create(ctx context.Context, elem tenancykit.User) error {
	var caller MethodCallForCreate
...
// Get implements the UserDBBackend.Get() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) Get(ctx context.Context, publicID string) (tenancykit.User, error) {
	var caller MethodCallForGet
...
// Update implements the UserDBBackend.Update() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) Update(ctx context.Context, publicID string, elem tenancykit.User) error {
	var caller MethodCallForUpdate
...
// GetAllByOrder implements the UserDBBackend.GetAllByOrder() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) GetAllByOrder(ctx context.Context, order string) ([]tenancykit.User, error) {
	var caller MethodCallForGetAllByOrder
...
// GetByField implements the UserDBBackend.GetByField() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.User, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the UserDBBackend.GetAll() method for the UserDBBackend.
func (impl *UserDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.User, int, error) {
	var caller MethodCallForGetAll
