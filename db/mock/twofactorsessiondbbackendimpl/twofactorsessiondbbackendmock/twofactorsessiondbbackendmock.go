...
type MethodCallForCreate struct {
	...
	Elem tenancykit.TwoFactorSession
...
func (impl *TwoFactorSessionDBBackendMock) Create(ctx context.Context, elem tenancykit.TwoFactorSession) (MethodCallForCreate, error) {
...
func (impl *TwoFactorSessionDBBackendMock) Update(ctx context.Context, publicID string, elem tenancykit.TwoFactorSession) (MethodCallForUpdate, error) {
...
// Create implements the TwoFactorSessionDBBackend.Create() method for the TwoFactorSessionDBBackend.
func (impl *TwoFactorSessionDBBackendSnitch) Create(ctx context.Context, elem tenancykit.TwoFactorSession) error {
	var caller MethodCallForCreate
...
// Get implements the TwoFactorSessionDBBackend.Get() method for the TwoFactorSessionDBBackend.
func (impl *TwoFactorSessionDBBackendSnitch) Get(ctx context.Context, publicID string) (tenancykit.TwoFactorSession, error) {
	var caller MethodCallForGet
...
// Update implements the TwoFactorSessionDBBackend.Update() method for the TwoFactorSessionDBBackend.
func (impl *TwoFactorSessionDBBackendSnitch) Update(ctx context.Context, publicID string, elem tenancykit.TwoFactorSession) error {
	var caller MethodCallForUpdate
...
// GetByField implements the TwoFactorSessionDBBackend.GetByField() method for the TwoFactorSessionDBBackend.
func (impl *TwoFactorSessionDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.TwoFactorSession, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the TwoFactorSessionDBBackend.GetAll() method for the TwoFactorSessionDBBackend.
func (impl *TwoFactorSessionDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.TwoFactorSession, int, error) {
	var caller MethodCallForGetAll
