...
func (impl *TenantDBBackendMock) Create(ctx context.Context, elem tenancykit.Tenant) (MethodCallForCreate, error) {
...
func (impl *TenantDBBackendMock) Update(ctx context.Context, publicID string, elem tenancykit.Tenant) (MethodCallForUpdate, error) {
...
type TenantDBBackendSnitch struct {
	...
	CreateMethodCalls []MethodCallForCreate
	CreateFunc        func(ctx context.Context, elem tenancykit.Tenant) error

	GetMethodCalls []MethodCallForGet
	GetFunc        func(ctx context.Context, publicID string) (tenancykit.Tenant, error)
	...
	GetAllMethodCalls []MethodCallForGetAll
	GetAllFunc        func(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.Tenant, int, error)
}
...
// Create implements the TenantDBBackend.Create() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) Create(ctx context.Context, elem tenancykit.Tenant) error {
	var caller MethodCallForCreate
...
// Get implements the TenantDBBackend.Get() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) Get(ctx context.Context, publicID string) (tenancykit.Tenant, error) {
	var caller MethodCallForGet
...
// Update implements the TenantDBBackend.Update() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) Update(ctx context.Context, publicID string, elem tenancykit.Tenant) error {
	var caller MethodCallForUpdate
...
// GetByField implements the TenantDBBackend.GetByField() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.Tenant, error) {
	var caller MethodCallForGetByField
...
// GetAll implements the TenantDBBackend.GetAll() method for the TenantDBBackend.
func (impl *TenantDBBackendSnitch) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.Tenant, int, error) {
	var caller MethodCallForGetAll
