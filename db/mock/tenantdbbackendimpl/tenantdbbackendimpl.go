...
func (impl TenantDBBackendImpl) Create(ctx context.Context, elem tenancykit.Tenant) error {
...
func (impl TenantDBBackendImpl) Get(ctx context.Context, publicID string) (tenancykit.Tenant, error) {
...
func (impl TenantDBBackendImpl) Update(ctx context.Context, publicID string, elem tenancykit.Tenant) error {
...
func (impl TenantDBBackendImpl) GetAllByOrder(ctx context.Context, order string, orderBy string) ([]tenancykit.Tenant, error) {
...
func (impl TenantDBBackendImpl) GetByField(ctx context.Context, key string, value interface{}) (tenancykit.Tenant, error) {
...
func (impl TenantDBBackendImpl) GetAll(ctx context.Context, order string, orderBy string, page int, responsePerPage int) ([]tenancykit.Tenant, int, error) {
