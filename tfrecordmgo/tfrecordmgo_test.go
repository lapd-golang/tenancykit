...
import (
	...
	mdb "github.com/gokit/tenancykit/tfrecordmgo"
)
...
var (
	...
	config = mongo.Config{
		Mode:     mgo.Monotonic,
		DB:       os.Getenv("tenancykit_MONGO_DB"),
		Host:     os.Getenv("tenancykit_MONGO_HOST"),
		User:     os.Getenv("tenancykit_MONGO_USER"),
		AuthDB:   os.Getenv("tenancykit_MONGO_AUTHDB"),
		Password: os.Getenv("tenancykit_MONGO_PASSWORD"),
	}
